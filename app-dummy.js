...
cityForm.addEventListener("submit",element => {
    ...
    fetch(url)
      ...
      .catch(() => {
        messageCity.textContent = "invalid city name, Please check your input and then try again";
      });
    ...
    // const isDuplicate = arrayTheList.find(isDuplicate => isDuplicate !== inputWord);  
    //   if (isDuplicate) {
